...
export default function MethodAlignmentControls({
    ...
    const resetAll = () => {
        const keysToRemove = ['alignItems', 'justifyContent', 'flexDirection', 'flexWrap'];
    ...
    return (
        <div className="method-control-set" style={{ width: '100%' }}>
            <ToolsPanel label="Alignment" resetAll={resetAll}>
                {include.includes('alignItems') && (
                    <ToolsPanelItem
                        label={alignItemsLabel}
                        hasValue={() => settings.alignItems !== undefined}
                        onDeselect={() => updateSettings('alignItems', undefined, true)}
                        onSelect={() => updateSettings('alignItems', 'flex-start')}
                    >
                        <ToggleGroupControl
                ...
                {include.includes('justifyContent') && (
                    <ToolsPanelItem
                        ...
                        hasValue={() => settings.justifyContent !== undefined}
                        onDeselect={() => updateSettings('justifyContent', undefined, true)}
                        onSelect={() => updateSettings('justifyContent', 'flex-start')}
                    >
                        <ToggleGroupControl
                            __next40pxDefaultSize
                            __nextHasNoMarginBottom
                ...
                {include.includes('flexDirection') && (
                    <ToolsPanelItem
                        label="Direction"
                        hasValue={() => settings.flexDirection !== undefined}
                        onDeselect={() => updateSettings('flexDirection', undefined, true)}
                        onSelect={() => updateSettings('flexDirection', 'row')}
                    >
                        <SelectControl
                            label="Direction"
                ...
                {include.includes('flexWrap') && (
                    <ToolsPanelItem
                        label="Flex Wrap"
                        hasValue={() => settings.flexWrap !== undefined}
                        onDeselect={() => updateSettings('flexWrap', undefined, true)}
                        onSelect={() => updateSettings('flexWrap', '')}
                    >
                        <SelectControl
                            label="Flex Wrap"
