...
export default function MethodAlignmentControls({
    ...
    if (breakpoint === 'base') {
        ...
        isEnabled = attributes?.responsiveSettings?.[breakpoint]?.customAlign;
    }
    ...
    return (
        <div style={{ width: '100%' }}>
                ...
                <PanelRow>
                    <div style={{ width: '100%' }}>
                        <CheckboxControl
                            ...
                            checked={!!isEnabled}
                            onChange={(value) =>
                                updateSettings('customAlign', value)
                            }
            ...
            {include.includes('alignItems') && !!isEnabled && (
                <PanelRow>
            ...
            {include.includes('justifyContent') && !!isEnabled && (
                <PanelRow>
                    <div style={{ width: '100%', marginBottom: '12px' }}>
                        <ToggleGroupControl
                            __next40pxDefaultSize
            ...
            {include.includes('flexDirection') && !!isEnabled && (
                <PanelRow>
                    <div style={{ width: '100%', marginBottom: '12px' }}>
                        <SelectControl
                            label="Direction"
