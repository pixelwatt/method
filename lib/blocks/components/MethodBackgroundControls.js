...
export default function MethodBackgroundControls({
    ...
    return (
        <Fragment>
            ...
            {attributes.bgImg?.full?.url && !!isEnabled && !isImg && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <div style={{ width: '100%' }}>
                        <p
                            style={{
            ...
            {attributes.bgImg?.full?.url && !!isEnabled && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <div style={{ width: '100%' }}>
                        <SelectControl
                            label="Display Size"
            ...
            {attributes.bgImg?.full?.url && !!isEnabled && settings?.bgDisplaySize === 'custom' && !isImg && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <Flex>
                        <FlexItem>
                            <UnitControl
