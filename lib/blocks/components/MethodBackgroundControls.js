...
export default function MethodBackgroundControls({
    ...
    return (
        <Fragment>
            ...
            {hasImage && !!isEnabled && !isImg && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <div style={{ width: '100%' }}>
                        <p
                            style={{
            ...
            {hasImage && !!isEnabled && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <div style={{ width: '100%' }}>
                        <SelectControl
                            label="Display Size"
            ...
            {hasImage && !!isEnabled && settings?.bgDisplaySize === 'custom' && !isImg && !attributes?.useParallax && !attributes?.bgVideo && (
                <PanelRow>
                    <Flex>
                        <FlexItem>
                            <UnitControl
