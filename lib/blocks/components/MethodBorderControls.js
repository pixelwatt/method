            ...
            <ToolsPanel label="Border" resetAll={resetAll}>
                {include.includes('border') && (
                    <ToolsPanelItem
                        ...
                        onSelect={() => updateSettings('border', { color: '#000000', style: 'solid', width: '1px' })}
                    >
                        <BorderBoxControl
                            label="Border"
                ...
                {include.includes('borderRadius') && (
                    <ToolsPanelItem
                        ...
                        onSelect={() => updateSettings('borderRadius', { topLeft: '0px', topRight: '0px', bottomLeft: '0px', bottomRight: '0px' })}
                    >
                        <BorderRadiusControl
                            label="Border Radius"
