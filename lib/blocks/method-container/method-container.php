...
function render_method_container_block( $block_attributes, $content, $block ) {
    ...
    $cssargs = array(
        ...
        '#' . $methodId . ' > .method-container-content' => array( 'color', 'bgColor', 'borderRadius', 'border', 'padding-left', 'padding-right', 'padding-top', 'padding-bottom', 'fontSize', 'lineHeight', 'height', 'minHeight', 'width', 'minWidth', 'alignItems', 'overflow', 'aspectRatioDimension', 'backdrop' ),
