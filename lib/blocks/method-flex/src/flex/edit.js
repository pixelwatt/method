...
export default function Edit({ attributes, setAttributes, clientId }) {
    ...
    const cssMap = {
        ...
        [`#block-${clientId} > .method-flex-inner-blocks`]: ['gap', 'justifyContent', 'alignItems', 'flexDirection', 'flexWrap', 'padding-top', 'padding-bottom', 'padding-left', 'padding-right',],
    };
        ...
        <>
            <InspectorControls>
                <MethodAlignmentControls
                    ...
                    include={['alignItems', 'justifyContent', 'flexDirection', 'flexWrap']}
                />
