            ...
            <Fragment>
                <InspectorControls>
                    ...
                    <MethodResponsive
                        attributes={attributes}
                        setAttributes={setAttributes}
                        breakpoints={methodGridData.breakpoints}
                        resetGapVals = {{ top: '0rem', bottom: '0rem', left: '1.5rem', right: '1.5rem' }}
                        renderMobile={
                            <>
                                <hr />
                ...
                <div>
                    ...
                    {customMobile && (
                        <style
                            dangerouslySetInnerHTML={{
                                __html: `
                                @media ( max-width: ${methodGridData.breakpoints.mobile_max} ) {
                                    #block-${clientId} {
                    ...
                    {customTablet && (
                        <style
                            dangerouslySetInnerHTML={{
                                __html: `
                                @media ( min-width: ${methodGridData.breakpoints.tablet_min} ) and ( max-width: ${methodGridData.breakpoints.tablet_max} ) {
                                    #block-${clientId} {
                    ...
                    {customWide && (
                        <style
                            dangerouslySetInnerHTML={{
                                __html: `
                                @media ( min-width: ${methodGridData.breakpoints.wide_min} ) {
                                    #block-${clientId} {
